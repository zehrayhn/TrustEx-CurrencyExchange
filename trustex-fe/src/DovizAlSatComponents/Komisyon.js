...
// Styled TableCell and TableRow components
        ...
        <AccordionSummary
          ...
          sx={{ 
            ...
            '& .MuiAccordionSummary-content': {
              borderRadius: '8px' // Ensures content respects the border radius
            }
          }}
        >
          <Typography>Komisyon Detaylari</Typography>
        </AccordionSummary>
        <AccordionDetails sx={{ borderRadius: '8px' }}> {/* Curved corners for details section */}
          <TableContainer component={Paper} sx={{ borderRadius: '8px' }}> {/* Curved corners for table */}
