        ...
        <Grid container spacing={3} style={{ marginTop: '24px'}}>
          <Grid item xs={12} style={{ padding: '16px' }}>
            ...
            <div
              ...
              <div className="absolute w-[300px] h-[50px] bg-darkblue text-white p-[50px] rounded-lg" style={{ top: '247px', left: '305px' }} value={dateOfBirth} onChange={(e) => setDateOfBirth(e.target.value)}  >
            ...
            <Button
              ...
              backgroundColor: "#0033a8", color: 'white', '&:hover': { backgroundColor: '#35aaff' } }} disabled={!checked} onClick={handleRegisterButton} >
              Kaydol
              </Button>
